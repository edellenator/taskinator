...
var taskFormHandler = function (event){
    ...
    // no data attribut, so create object as normal and pas to createTaskEl function
    else {
...
var createTaskEl = function(taskDataObject) {
    ...
    taskInfoEl.innerHTML = 
        "<h3 class = 'task-name'>" + taskDataObject.name + "</h3><span class='task-type'>" + taskDataObject.type + "</span>";
...
var taskStatusChangeHandler = function(event) {
    ...
    //get current status option and convert to lowercase
    var statusValue = event.target.value.toLowerCase();

    //get the parent task item element based on the task id
    var taskSelected = document.querySelector(".task-item[data-task-id='" + taskId + "']");
